...
fileToRead = "file_name.csv"  #csv file name or absolute path to be open.
fileToWrite = "file_name.arff" #name as how you'll save your arff file.
relation = "file_name" #how you'll like to call your relation as.
